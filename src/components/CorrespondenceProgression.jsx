  ...
  return (
    <div className="space-y-8">
      <div className="bg-white border border-[#e5e7eb] rounded-lg p-5 shadow-sm">
        <h2 className="text-lg font-semibold text-[#4a2200] mb-4">Letters Per Year by Sender</h2>
      ...
      <div className="bg-white border border-[#e5e7eb] rounded-lg p-5 shadow-sm">
        <h2 className="text-lg font-semibold text-[#4a2200] mb-4">Top Correspondents – Correspondence Spans</h2>
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-[#ddd] text-left">
                <th className="py-2 pr-4 text-[#4a2200] font-semibold">Receiver</th>
      ...
      <div className="bg-white border border-[#e5e7eb] rounded-lg p-5 shadow-sm">
        <h2 className="text-lg font-semibold text-[#4a2200] mb-4">Activity by Decade</h2>
      ...
      <table className="text-sm w-full">
        <thead>
          <tr>
            ...
            {allKeys.map(k => <th key={k} className="py-2 px-3 text-left text-[#888] whitespace-nowrap">{k}</th>)}
          </tr>
        </thead>
        <tbody>
          {matrix.map(row => (
